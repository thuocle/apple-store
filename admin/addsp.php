        ...
        <div style="margin: auto;">
            <form action="xuly.php" method="POST" enctype="multipart/form-data">
                ...
                ?>
                    <tr>
                        <td>Mã sản phẩm</td>
                        <td><input name="masp" value="<?php echo $_GET['id'] ?>" type="text" placeholder="Tên sản phẩm"
                                readonly /></td>
                    </tr>
                    <?php
                        }
                ?>
                    ...
                    <tr>
                        <td>Chip</td>
                        <td><input name="chip" type="text" placeholder="Chip" /></td>
                    </tr>
                    <tr>
                        <td>CPU</td>
                        <td><input name="cpu" type="text" placeholder="CPU" /></td>
                    </tr>
                    <tr>
                        <td>GPU</td>
                        <td><input name="gpu" type="text" placeholder="GPU" /></td>
                    </tr>
                    <tr>
                        <td>TouchID</td>
                        <td><input name="tid" type="text" placeholder="TouchID" /></td>
                    </tr>
                    <tr>
                        <?php
                        if(isset($_GET['id']))
